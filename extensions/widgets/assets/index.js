...
var Mutation = (_f = class extends Removable {
  ...
  continue() {
    var _a2, _b2;
    return (_b2 = (_a2 = __privateGet(this, _retryer2)) == null ? void 0 : _a2.continue()) != null ? _b2 : this.execute(this.state.variables);
  }
  async execute(variables) {
    ...
    const executeMutation = () => {
      ...
      __privateSet(this, _retryer2, createRetryer({
        ...
        retry: (_a3 = this.options.retry) != null ? _a3 : 0,
...
var MutationCache = (_g = class extends Subscribable {
  ...
  resumePausedMutations() {
    var _a2;
    __privateSet(this, _resuming, ((_a2 = __privateGet(this, _resuming)) != null ? _a2 : Promise.resolve()).then(() => {
      ...
      const fetchFn = async () => {
        ...
        if (direction && oldPages.length) {
          ...
          result = await fetchPage(
            empty,
            (_f2 = oldPageParams[0]) != null ? _f2 : options.initialPageParam
          );
...
var QueryClient = (_h = class {
  ...
  invalidateQueries(filters = {}, options = {}) {
    return notifyManager.batch(() => {
      ...
      const refetchFilters = {
        ...filters,
        type: (_b2 = (_a2 = filters.refetchType) != null ? _a2 : filters.type) != null ? _b2 : "active"
      };
      return this.refetchQueries(refetchFilters, options);
    });
  }
  refetchQueries(filters = {}, options) {
    ...
    const fetchOptions = {
      ...options,
      cancelRefetch: (_a2 = options == null ? void 0 : options.cancelRefetch) != null ? _a2 : true
    };
    const promises = notifyManager.batch(
...
var useQueryClient = (queryClient2) => {
  const client = react.exports.useContext(QueryClientContext);
  if (queryClient2) {
    return queryClient2;
  }
  if (!client) {
...
var IsRestoringContext = react.exports.createContext(false);
var useIsRestoring = () => react.exports.useContext(IsRestoringContext);
...
var QueryErrorResetBoundaryContext = react.exports.createContext(createValue());
var useQueryErrorResetBoundary = () => react.exports.useContext(QueryErrorResetBoundaryContext);
...
function useBaseQuery(options, Observer, queryClient2) {
  ...
  const [observer] = react.exports.useState(
    () => new Observer(
      client,
      defaultedOptions
    )
  ...
  react.exports.useSyncExternalStore(
...
const fetchReviews = async ({
  ...
  const res = axios$1.get(`${rvxpo_url}/-/api/storefront/${rvxpo_clientId}/widgets/products/${productId}/reviews/?shop=${rvxpo_shopDomain}&order_by=desc&rating=all&page=${pageParam}`);
  return res;
};
function Card({
  productId
  ...
  const {
    ...
    getNextPageParam: (results) => {
      var _a3, _b2, _c2, _d2;
      return ((_b2 = (_a3 = results == null ? void 0 : results.data) == null ? void 0 : _a3.data) == null ? void 0 : _b2.meta.next_page_url) && ((_d2 = (_c2 = results == null ? void 0 : results.data) == null ? void 0 : _c2.data) == null ? void 0 : _d2.meta.current_page) + 1;
    }
  });
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [/* @__PURE__ */ jsx("button", {
      ...
      className: "container",
      children: ["4Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam in suscipit, quia pariatur soluta illo magnam labore mollitia molestiae quibusdam exercitationem quisquam ex inventore consectetur enim accusamus. Eveniet, sunt voluptatibus.34", (_a2 = data == null ? void 0 : data.pages) == null ? void 0 : _a2.map((page) => {
        var _a3, _b2;
        return (_b2 = (_a3 = page == null ? void 0 : page.data) == null ? void 0 : _a3.data) == null ? void 0 : _b2.reviews.map((item) => {
...
function App({
  rvxpo_clientId: rvxpo_clientId2,
  rvxpo_url: rvxpo_url2,
  rvxpo_shopDomain: rvxpo_shopDomain2,
  rvxpo_productId: rvxpo_productId2
}) {
  console.log(rvxpo_clientId2, rvxpo_url2, rvxpo_productId2, rvxpo_shopDomain2, "rvxpo_clientId");
  return /* @__PURE__ */ jsx(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ jsx(Card, {
      productId: rvxpo_productId2
    })
  });
}
